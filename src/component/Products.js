            ...
            <div className="container my-5 py-5">
                <div className="row App ">
                    ...
                    <div className="buttons d-flex justify-content-center mb-5 pb-5">
                        ...
                        <button
                            className="btn btn-outline-dark me-2"
                            onClick={() => setCurrentCategory("laptops")}
                        >
                            Laptops
                        </button>
                        <button
                            className="btn btn-outline-dark me-2"
                            onClick={() => setCurrentCategory("fragrances")}
                        >
                            Fragrances
                        </button>
                        <button
                            className="btn btn-outline-dark me-2"
                            onClick={() => setCurrentCategory("skincare")}
                        >
                            Skin Care
                        </button>
                        <button
                            className="btn btn-outline-dark me-2"
                            onClick={() => setCurrentCategory("groceries")}
                        >
                            Groceries
                        </button>
                        <button
                            className="btn btn-outline-dark me-2"
                            onClick={() => setCurrentCategory("home-decoration")}
                        >
                            Home Decoration
                        </button>
                    </div>
